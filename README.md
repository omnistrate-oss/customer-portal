...
| PROVIDER_API_KEY            | Service provider's Omnistrate API key (must have at least Admin-level privileges). When set, it is used instead of PROVIDER_EMAIL/PROVIDER_PASSWORD to authenticate to Omnistrate                                                                                          |
