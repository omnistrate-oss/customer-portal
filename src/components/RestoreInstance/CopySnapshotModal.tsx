  ...
  return (
    <InformationDialogTopCenter open={open} handleClose={handleClose} maxWidth={"550px"}>
        ...
        <Stack direction={"row"} justifyContent={"flex-start"} alignItems={"flex-start"} gap="16px">
          ...
          <Box>
            <Text size="large" weight="semibold" color="#181D27">
              {snapshotCreationType === "copyFromExisting" && tab === "snapshots" ? "Copy Snapshot" : "Create Snapshot"}
            </Text>
      ...
      <DialogFooter>
        ...
        <Button variant="contained" disabled={copySnapshotMutation.isPending} onClick={copySnapshotFormik.handleSubmit}>
          {snapshotCreationType === "copyFromExisting" && tab === "snapshots" ? "Copy Snapshot" : "Create Snapshot"}
