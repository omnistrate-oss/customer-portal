  ...
  return (
    <PageContainer>
      ...
      <FullScreenDrawer
        title="Cloud Account"
        description={
          overlayType === "modify-instance-form" ? "Modify this cloud account" : "View cloud account details"
        }
        open={
          isOverlayOpen &&
          (overlayType === "view-instance-form" || overlayType === "modify-instance-form")
        }
        closeDrawer={() => {
          setIsOverlayOpen(false);
          setClickedInstance(undefined);
        ...
        RenderUI={
          <CloudAccountForm
            ...
            formMode={overlayType === "modify-instance-form" ? "modify" : "view"}
